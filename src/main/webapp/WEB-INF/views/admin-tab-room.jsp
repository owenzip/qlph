...
<div class="row">
    <div class="col-md-12">
        ...
        <label><b>Danh sách phòng</b></label>
...
<div class="modal fade" id="modalSelectRoom" tabindex="-1" role="dialog" aria-labelledby="modalSelectRoomAdmin"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <button id="btnBookedRoomAdmin" style="width: 100%" type="button" class="btn btn-red">Đang đặt
                            &nbsp;&nbsp;<i class="fa fa-bell"></i></button>
                        <button id="btnLiveRoomAdmin" style="width: 100%" type="button" class="btn btn-red">Hoạt động
                            &nbsp;&nbsp;<i class="fa fa-wifi"></i></button>
                        <button id="btnEndRoomAdmin" style="width: 100%" type="button" class="btn btn-red">Kết thúc
                            &nbsp;&nbsp;<i class="fa fa-check-square"></i></button>
                        <button id="btnCanceledRoomAdmin" style="width: 100%" type="button" class="btn btn-red">Hủy
                            phòng&nbsp;&nbsp;<i class="fa fa-ban"></i></button>
                        <button id="btnDeleteRoomAdmin" style="width: 100%" type="button" class="btn btn-red">Xóa phòng&nbsp;&nbsp;<i
