...
<script type="text/javascript" src="<c:url value="../../resources/js/others/jquery.validate.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="../../resources/js/others/additional-jquery.validate.js"/>"></script>
